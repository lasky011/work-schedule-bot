...
def welcome_card(name_part: str, action: str) -> str:
    body = (
        "Теперь всё основное живёт в <b>TNG Alice</b> — мини-приложении внутри Telegram.\n\n"
        "Там график, коллеги, сравнение смен, зарплата, учёт часов, уведомления и темы.\n\n"
        "В чате оставил только быстрые действия: посмотреть сегодня и открыть профиль."
    )
